...
#list containing a function to set the value of the matrix,get the value of the 
...
#The following function calculates the inverse of the special cacheMatrix created 
